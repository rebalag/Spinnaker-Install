...
oc create configmap bomconfig --from-file=1.13.6/bom.yml -n $spinnaker_namespace

#cloudriver 
oc create  configmap clouddriverbomconfig -n $spinnaker_namespace --from-file=1.13.6/clouddriver.yml 

#deck
oc create configmap deckbomconfig -n $spinnaker_namespace --from-file=1.13.6/settings.js

#echo
oc create configmap echobomconfig -n $spinnaker_namespace --from-file=1.13.6/echo.yml 

#fiat
oc create configmap fiatbomconfig -n $spinnaker_namespace --from-file=1.13.6/fiat.yml

#front50
oc create configmap front50bomconfig -n $spinnaker_namespace --from-file=1.13.6/front50.yml

#gate
oc create configmap gatebomconfig -n $spinnaker_namespace --from-file=1.13.6/gate.yml

#igor
oc create configmap igorbomconfig -n $spinnaker_namespace --from-file=1.13.6/igor.yml

#orca
oc create configmap orcabomconfig -n $spinnaker_namespace --from-file=1.13.6/orca.yml

#rosco
oc create configmap roscobomconfig -n $spinnaker_namespace --from-file=1.13.6/rosco.yml
oc create configmap roscoimagebomconfig -n $spinnaker_namespace --from-file=1.13.6/images.yml
