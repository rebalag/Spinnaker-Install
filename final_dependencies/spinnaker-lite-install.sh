...
kubectl create configmap bomconfig --from-file=1.12.1/bom.yml -n $spinnaker_namespace

#cloudriver 
kubectl create  configmap clouddriverbomconfig -n $spinnaker_namespace --from-file=1.12.1/clouddriver.yml 

#deck
kubectl create configmap deckbomconfig -n $spinnaker_namespace --from-file=1.12.1/settings.js

#echo
kubectl create configmap echobomconfig -n $spinnaker_namespace --from-file=1.12.1/echo.yml 

#fiat
kubectl create configmap fiatbomconfig -n $spinnaker_namespace --from-file=1.12.1/fiat.yml

#front50
kubectl create configmap front50bomconfig -n $spinnaker_namespace --from-file=1.12.1/front50.yml

#gate
kubectl create configmap gatebomconfig -n $spinnaker_namespace --from-file=1.12.1/gate.yml

#igor
kubectl create configmap igorbomconfig -n $spinnaker_namespace --from-file=1.12.1/igor.yml

#orca
kubectl create configmap orcabomconfig -n $spinnaker_namespace --from-file=1.12.1/orca.yml

#rosco
kubectl create configmap roscobomconfig -n $spinnaker_namespace --from-file=1.12.1/rosco.yml
kubectl create configmap roscoimagebomconfig -n $spinnaker_namespace --from-file=1.12.1/images.yml
